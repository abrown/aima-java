...
public class QLearningAgentTest extends ReinforcementLearningAgentTest {
    ...
    public void setUp() {
        ...
        qla = new QLearningAgent<Cell<Double>, CellWorldAction>(MDPFactory.createActionsFunctionForFigure17_1(cw), CellWorldAction.actions(), CellWorldAction.None, 0.2, 1.0, 5, 2.0);
