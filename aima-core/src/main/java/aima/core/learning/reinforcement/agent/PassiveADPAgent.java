...
/**
 * Artificial Intelligence A Modern Approach (3rd Edition): page 834.<br> <br>
 *
 * <pre>
...
public class PassiveADPAgent<S, A extends Action> extends ReinforcementAgent<S, A> {
     ...
     * Constructor.
     *
     * @param fixedPolicy &pi; a fixed policy.
     * @param states the possible states in the world (i.e. fully observable).
     * @param initialState the initial state for the agent.
     * @param actionsFunction a function that lists the legal actions from a
     * state.
     * @param policyEvaluation a function for evaluating a policy.
     */
