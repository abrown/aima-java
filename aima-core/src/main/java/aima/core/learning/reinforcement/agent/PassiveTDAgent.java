...
/**
 * Artificial Intelligence A Modern Approach (3rd Edition): page 837.<br> <br>
 *
 * <pre>
...
public class PassiveTDAgent<S, A extends Action> extends ReinforcementAgent<S, A> {
     ...
     * <br> <b>Note:</b> override this method to obtain the desired behavior.
     *
     * @param Ns a frequency counter of observed states.
