...
/**
 * Thrown when a perceptron is ordered to send a signal, but does not know where
 * to send it to
 *
 * @author Andrew Brown
 */
public class UnlinkedPerceptronException extends Exception {
     ...
     * <code>UnlinkedPerceptronException</code> without detail message.
     */
     ...
     * <code>UnlinkedPerceptronException</code> with the specified detail
     * message.
     *
